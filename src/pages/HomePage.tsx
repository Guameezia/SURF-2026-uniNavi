    ...
    <div className="tab-page home-page">
      ...
      {showDebugToggle && debugMode && (
        <div className="legend">
          ...
          <div className="legend-item">
            <span className="legend-dot" style={{ backgroundColor: "#FF9800" }} />
            出口
          </div>
          <div className="legend-item">
            <span className="legend-dot" style={{ backgroundColor: "#9C27B0" }} />
            电梯
          </div>
          <div className="legend-item">
            <span className="legend-dot" style={{ backgroundColor: "#E91E63" }} />
            楼梯
          </div>
        </div>
      )}
